...
def Dice3d(a, b):
    ...
    # TASK_COMPLETED: Write implementation of Dice3D. If you completed exercises in the lessons
...
def Jaccard3d(a, b):
    ...
    # TASK_COMPLETED: Write implementation of Jaccard similarity coefficient. Please do not use 
